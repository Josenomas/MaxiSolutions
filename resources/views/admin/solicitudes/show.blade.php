                ...
                <form action="{{ route('admin.solicitudes.update', $solicitud) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="estado" class="form-select" required>
                            ...
                            <option value="en_desarrollo" {{ $solicitud->estado == 'en_desarrollo' ? 'selected' : '' }}>💻 En Desarrollo</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="monto_cotizado" class="form-control" value="{{ $solicitud->monto_cotizado }}" min="0" step="1000" placeholder="Ej: 500000">
                        <small class="text-muted">Opcional: Monto a cobrar al cliente</small>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Fecha Estimada de Entrega</label>
                        <input type="date" name="fecha_estimada_entrega" class="form-control" value="{{ $solicitud->fecha_estimada_entrega?->format('Y-m-d') }}">
                    </div>
