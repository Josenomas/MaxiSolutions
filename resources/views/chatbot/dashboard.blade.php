...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="{{ route('chatbot.dashboard') }}">
                <i class="fas fa-graduation-cap"></i> Chatbot Prep
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('chatbot.dashboard') }}">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('chatbot.practica') }}">Practicar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('chatbot.simulador') }}">Simulador</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('chatbot.estadisticas') }}">Estadísticas</a>
                    </li>
    ...
    <div class="container my-5">
        <div class="row mb-4">
            <div class="col-12">
                ...
                <p class="text-muted">Prepárate para la Chatbot con nuestro sistema de práctica inteligente</p>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <a href="{{ route('chatbot.practica') }}" class="btn btn-primary">Practicar</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h5>Simulador Chatbot</h5>
                        <p class="text-muted">Simula un examen completo oficial</p>
                        <a href="{{ route('chatbot.simulador') }}" class="btn btn-success">Simular</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <a href="{{ route('chatbot.estadisticas') }}" class="btn btn-info">Ver stats</a>
                    </div>
                </div>
            </div>
        </div>
