...
<head>
    ...
    <title>Registro - PAES Prep</title>
            ...
            <div class="card shadow-lg">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="mt-3">Únete a PAES Prep</h2>
                    ...
                    <form method="POST" action="{{ route('paes.register') }}">
                        @csrf
                        ...
                        <div class="text-center">
                            <p class="mb-0">¿Ya tienes cuenta? <a href="{{ route('paes.login') }}">Inicia sesión</a></p>
                            <a href="{{ route('paes.home') }}" class="text-muted d-block mt-2">
