...
@section('title', 'PAES Prep - Alcanza tu máximo puntaje en la PAES')
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        ...
        <h1 class="my-3 reveal">Alcanza tu <span class="ms-grad-text">máximo puntaje</span> en la PAES</h1>
        ...
        <div class="d-flex flex-wrap gap-3 mb-4 reveal">
          ...
          <a href="{{ route('paes.dashboard') }}" class="ms-btn ms-btn-ghost"><i class="fas fa-graduation-cap"></i> Comenzar gratis</a>
        </div>
      ...
      <div class="col-lg-6">
        <div class="ms-window reveal">
          ...
          <div class="ms-code">
            <span class="ln"><span class="c-key">class</span> <span class="c-fn">EstudiantePAES</span> {</span>
  ...
  <div class="container">
    <div class="ms-stats reveal">
      <div class="row text-center g-0">
        ...
        <div class="col-6 col-md-3 ms-stat py-4"><div class="num ms-grad-text" data-count="4">0</div><div class="lbl">Materias PAES</div></div>
  ...
  <div class="container">
    <div class="ms-cta text-center reveal">
      ...
      <div class="ms-cta-inner mx-auto" style="max-width:640px">
        ...
        <p class="lead mb-4" style="color:rgba(255,255,255,.78)">Comienza gratis hoy y descubre cómo la IA puede transformar tu preparación para la PAES.</p>
        <a href="{{ route('paes.dashboard') }}" class="ms-btn ms-btn-primary btn-lg"><i class="fas fa-graduation-cap"></i> Comenzar ahora gratis</a>
      </div>
    </div>
  </div>
</section>
